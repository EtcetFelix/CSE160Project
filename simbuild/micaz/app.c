...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x7fbeb3838020, const void *arg_0x7fbeb3838320);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x7fbeb37b05e0) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7fbeb35533a0), 
int (*key_eq_fn)(void *arg_0x7fbeb3553b70, void *arg_0x7fbeb3553e30));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7fbeb3340c00, int arg_0x7fbeb3340e80);
static double RandomUniform(void );
...
static void FloodingP__Flooding__Flood(pack *myMsg);
#line 2
static void FloodingP__Flooding__ping(uint16_t destination, uint8_t *payload);
...
static bool /*FloodingC.HashmapC*/HashmapC__0__Hashmap__contains(uint32_t key);
...
# 3 "lib/interfaces/Flooding.nc"
static void Node__Flooding__Flood(pack *myMsg);
#line 2
static void Node__Flooding__ping(uint16_t destination, uint8_t *payload);
# 5 "lib/interfaces/NeighborDiscovery.nc"
...
# 13 "dataStructures/interfaces/Hashmap.nc"
static FloodingP__PreviousPackets__t FloodingP__PreviousPackets__get(uint32_t key);
#line 11
static void FloodingP__PreviousPackets__insert(uint32_t key, FloodingP__PreviousPackets__t input);


static bool FloodingP__PreviousPackets__contains(uint32_t key);
# 4 "lib/interfaces/SimpleSend.nc"
static error_t FloodingP__simpleSend__send(pack msg, uint16_t dest);
# 12 "lib/modules/FloodingP.nc"
pack FloodingP__sendPackage[1000];
uint16_t FloodingP__sequenceNum[1000];
...
static inline bool FloodingP__containsval(uint32_t key, uint32_t val);
...
static inline void FloodingP__Flooding__ping(uint16_t destination, uint8_t *payload);
...
static inline void FloodingP__Flooding__Flood(pack *letter);
# 97 "/opt/tinyos-main/tos/interfaces/Pool.nc"
static 
#line 94
...
#line 143
static inline bool /*FloodingC.HashmapC*/HashmapC__0__Hashmap__contains(uint32_t k);
# 52 "/opt/tinyos-main/tos/interfaces/Random.nc"
...
inline static void FloodingP__PreviousPackets__insert(uint32_t key, FloodingP__PreviousPackets__t input){
#line 11
...
# 13 "dataStructures/interfaces/Hashmap.nc"
inline static FloodingP__PreviousPackets__t FloodingP__PreviousPackets__get(uint32_t key){
#line 13
...
inline static bool FloodingP__PreviousPackets__contains(uint32_t key){
#line 14
  unsigned char __nesc_result;
#line 14

#line 14
  __nesc_result = /*FloodingC.HashmapC*/HashmapC__0__Hashmap__contains(key);
#line 14
...
#line 24
{
  if (FloodingP__PreviousPackets__contains(key)) {
      if (FloodingP__PreviousPackets__get(key) == val) {
          return TRUE;
        }
    }
}
...
#line 42
  if (FloodingP__containsval(__nesc_ntoh_uint16(letter->seq.nxdata), __nesc_ntoh_uint16(letter->src.nxdata))) {
      sim_log_debug(181U, FLOODING_CHANNEL, "Duplicate packet. Will not forward...\n");
    }
  else {
#line 44
    if (__nesc_ntoh_uint8(letter->TTL.nxdata) == 0) {
        sim_log_debug(182U, FLOODING_CHANNEL, "Packet has expired. Will not forward to prevent infinite loop...\n");
      }
    else {
#line 46
      if (__nesc_ntoh_uint16(letter->dest.nxdata) == TOS_NODE_ID) {
          if (__nesc_ntoh_uint8(letter->protocol.nxdata) == PROTOCOL_PING) {
              sim_log_debug(183U, FLOODING_CHANNEL, "Package has reached the destination!...\n");


              FloodingP__PreviousPackets__insert(__nesc_ntoh_uint16(letter->seq.nxdata), __nesc_ntoh_uint16(letter->src.nxdata));
              FloodingP__makePack(&FloodingP__sendPackage[sim_node()], __nesc_ntoh_uint16(letter->dest.nxdata), __nesc_ntoh_uint16(letter->src.nxdata), 10, PROTOCOL_PINGREPLY, FloodingP__sequenceNum[sim_node()]++, (uint8_t *)letter->payload, PACKET_MAX_PAYLOAD_SIZE);
              FloodingP__simpleSend__send(FloodingP__sendPackage[sim_node()], AM_BROADCAST_ADDR);
              sim_log_debug(184U, FLOODING_CHANNEL, "RePackage has been resent!...\n");
            }
          else {
#line 55
            if (__nesc_ntoh_uint8(letter->protocol.nxdata) == PROTOCOL_PINGREPLY) {
                sim_log_debug(185U, FLOODING_CHANNEL, "RePackage has reached destination...\n");
...
#line 60
        {
          (__nesc_temp42 = letter->TTL.nxdata, __nesc_hton_uint8(__nesc_temp42, __nesc_ntoh_uint8(__nesc_temp42) - 1));

          FloodingP__PreviousPackets__insert(__nesc_ntoh_uint16(letter->seq.nxdata), __nesc_ntoh_uint16(letter->src.nxdata));
          FloodingP__simpleSend__send(*letter, AM_BROADCAST_ADDR);

          sim_log_debug(186U, FLOODING_CHANNEL, "New package has been forwarded with new Time To Live...\n");
        }
      }
    }
}
...
# 3 "lib/interfaces/Flooding.nc"
inline static void Node__Flooding__Flood(pack *myMsg){
#line 3
  FloodingP__Flooding__Flood(myMsg);
#line 3
}
#line 3
...
#line 28
{
  ...
  if (__nesc_ntoh_uint8(packet->TTL.nxdata) > 0 && __nesc_ntoh_uint8(packet->protocol.nxdata) == PROTOCOL_PING) {
      sim_log_debug(208U, NEIGHBOR_CHANNEL, "PING Neighbor Discovery\n");
...
#line 38
    if (__nesc_ntoh_uint8(packet->protocol.nxdata) == PROTOCOL_PINGREPLY && __nesc_ntoh_uint16(packet->dest.nxdata) == 0) {
        sim_log_debug(209U, NEIGHBOR_CHANNEL, "PING REPLY Neighbor Discovery, Confirmed neighbor %d\n", __nesc_ntoh_uint16(packet->src.nxdata));
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7fbeb3031e30, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7fbeb3031e30) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7fbeb3031e30, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7fbeb3030a50, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7fbeb3030a50, msg, payload, len);
#line 78
...
# 110 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7fbeb304bc70, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7fbeb304bc70, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7fbeb29f5940, message_t * msg, error_t error){
#line 100
  switch (arg_0x7fbeb29f5940) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7fbeb29f5940, msg, error);
#line 100
      break;
#line 100
    }
...
#line 32
{
  sim_log_debug(178U, FLOODING_CHANNEL, "PING EVENT \n");
  sim_log_debug(179U, FLOODING_CHANNEL, "SENDER %d\n", TOS_NODE_ID);
  sim_log_debug(180U, FLOODING_CHANNEL, "DEST %d\n", destination);
  FloodingP__makePack(&FloodingP__sendPackage[sim_node()], TOS_NODE_ID, destination, 22, PROTOCOL_PING, FloodingP__sequenceNum[sim_node()], payload, PACKET_MAX_PAYLOAD_SIZE);
  FloodingP__simpleSend__send(FloodingP__sendPackage[sim_node()], AM_BROADCAST_ADDR);
  FloodingP__sequenceNum[sim_node()]++;
}

# 2 "lib/interfaces/Flooding.nc"
inline static void Node__Flooding__ping(uint16_t destination, uint8_t *payload){
#line 2
  FloodingP__Flooding__ping(destination, payload);
#line 2
}
#line 2
# 73 "Node.nc"
...
#line 73
{
  Node__Flooding__ping(destination, payload);
}
...
# 75 "/opt/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7fbeb3214020){
#line 75
  switch (arg_0x7fbeb3214020) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7fbeb3214020);
#line 75
      break;
#line 75
    }
...
#line 78
# 80 "/opt/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7fbeb29f4b60, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7fbeb29f4b60, addr, msg, len);
#line 80
...
#line 79
  sim_log_debug(226U, HASHMAP_CHANNEL, "Removing entry %d\n", k);
  for (i = 0; i < /*NeighborDiscoveryC.HashmapC*/HashmapC__1__numofVals[sim_node()]; i++) {
      ...
      if (/*NeighborDiscoveryC.HashmapC*/HashmapC__1__keys[sim_node()][i] == k) {
          sim_log_debug(227U, HASHMAP_CHANNEL, "Key found at %d\n", i);
...
#line 91
          ...
          sim_log_debug(230U, "hashmap", "Done removing entry\n");
          return;
        }
    }
}
...
#line 60
      if (NeighborDiscoveryP__NeighborTable__get(neighbors[i]) == 0) {
          sim_log_debug(210U, NEIGHBOR_CHANNEL, "Deleted Neighbor %d\n", neighbors[i]);
...
# 83 "/opt/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7fbeb2aa6950){
#line 83
  switch (arg_0x7fbeb2aa6950) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7fbeb2aa6950);
#line 83
      break;
#line 83
    }
...
#line 22
{
  ...
  sim_log_debug(207U, NEIGHBOR_CHANNEL, "Node %d: Began Neighbor Discovery\n", TOS_NODE_ID);
  return SUCCESS;
}
...
#line 42
  ...
  if (k == /*NeighborDiscoveryC.HashmapC*/HashmapC__1__EMPTY_KEY[sim_node()]) {
      sim_log_debug(225U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*NeighborDiscoveryC.HashmapC*/HashmapC__1__EMPTY_KEY[sim_node()]);
      return;
    }
...
#line 42
  ...
  if (k == /*FloodingC.HashmapC*/HashmapC__0__EMPTY_KEY[sim_node()]) {
      sim_log_debug(201U, HASHMAP_CHANNEL, "[HASHMAP] You cannot insert a key of %d.", /*FloodingC.HashmapC*/HashmapC__0__EMPTY_KEY[sim_node()]);
      return;
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module FloodingP */
  if (!strcmp(varname, "FloodingP__sendPackage"))
  {
    *addr = (uintptr_t)&FloodingP__sendPackage[__nesc_mote];
    *size = sizeof(FloodingP__sendPackage[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "FloodingP__sequenceNum"))
  {
    *addr = (uintptr_t)&FloodingP__sequenceNum[__nesc_mote];
    *size = sizeof(FloodingP__sequenceNum[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module FloodingP */
  memset((void *)&FloodingP__sendPackage[__nesc_mote], 0, sizeof FloodingP__sendPackage[__nesc_mote]);
  FloodingP__sequenceNum[__nesc_mote] = 0;
